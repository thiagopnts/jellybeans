...
local theme = lush(function()
	return {
		...
		SpellBad({ guisp = old_brick, gui = "undercurl", term = "underline", cterm = "underline" }), -- Word that is not recognized by the spellchecker. |spell| Combined with the highlighting used otherwise.
		SpellCap({ guisp = dark_blue, gui = "undercurl", term = "underline", cterm = "underline" }), -- Word that should start with a capital. |spell| Combined with the highlighting used otherwise.
		SpellLocal({ guisp = casal, gui = "undercurl", term = "underline", cterm = "underline" }), -- Word that is recognized by the spellchecker as one that is used in another region. |spell| Combined with the highlighting used otherwise.
		SpellRare({ guisp = old_brick, gui = "undercurl", term = "underline", cterm = "underline" }), -- Word that is recognized by the spellchecker as one that is hardly ever used.  |spell| Combined with the highlighting used otherwise.
